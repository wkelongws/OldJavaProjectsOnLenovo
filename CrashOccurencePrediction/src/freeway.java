...
public class freeway extends Configured implements Tool {
	
	public static void main ( String[] args ) throws Exception {
		
		int res = ToolRunner.run(new Configuration(), new freeway(), args);
		System.exit(res); 
	...
	public int run ( String[] args ) throws Exception {
		...
		String input1 = "freeway/Inrix.txt";    // Change this accordingly
		//String input1 = "InrixWaveT/Inrix/inrix/1-11/1-11.txt";    // Change this accordingly
		//String input1 = "iw/i.txt"; 
		String input2 = "freeway/Wave.txt";    // Change this accordingly
		...
		String output = "freeway/result";  		// Change this accordingly
		//String output = "result"; 
		String matchtable = "freeway/match/part-m-00000";
		...
		job_one.setJarByClass(freeway.class); 
