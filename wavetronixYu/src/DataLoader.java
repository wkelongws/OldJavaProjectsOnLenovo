...
public class DataLoader {
	...
	public List<Wavetronix> getWavetronixData() {
		...
		String currentDate = new SimpleDateFormat("MMddyyyy").format(new java.util.Date());
		String currentTime = new SimpleDateFormat("hhmmss").format(new java.util.Date());
//		String waveXMLPath = "C:/Users/Shuo/Desktop/WavetronixData/waveCSV/New folder";
		String waveXMLPath = "./wavetronixXMLs/" + currentDate;
		File xmlDir = new File(waveXMLPath);
        if(!xmlDir.exists()){
            xmlDir.mkdir();
        }
//		String waveXMLPath = "./temp";
		String waveFileName = currentTime + ".xml";
